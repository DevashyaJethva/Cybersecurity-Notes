...
A **computer network** is a group of devices connected together to share data, resources, and communication services.
...
- Routers
- Switches
- IoT devices (CCTV, sensors, smart devices)
...
- Communication between systems (email, messaging, websites)
- Connecting offices, universities, and global systems
- Running online services such as banking, gaming, and cloud platforms

In cybersecurity, understanding networking helps in:

- Traffic analysis
- Finding vulnerabilities
- Using tools like **Nmap**, **Wireshark**, **Burp Suite**
- Performing penetration testing and defense
...
Example: Internet connection provided across a city by an ISP.
